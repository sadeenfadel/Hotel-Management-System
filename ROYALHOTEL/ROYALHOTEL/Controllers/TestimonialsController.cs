...
namespace ROYALHOTEL.Controllers
{
    public class TestimonialsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Testimonialid,Imageurl,Testimonialtext")] Testimonial testimonial)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Testimonialid,Imageurl,Testimonialtext")] Testimonial testimonial)
        {
