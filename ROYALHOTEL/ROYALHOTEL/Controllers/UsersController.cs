...
namespace ROYALHOTEL.Controllers
{
    public class UsersController : Controller
    {
       ...
       private readonly IWebHostEnvironment _webHostEnviroment;
        ...
        public async Task<IActionResult> Create([Bind("Userid,Userfname,Userlname,Email,ImageFile")] User user)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Userid,Userfname,Userlname,Email,ImageFile")] User user)
        {
            if (id != user.Userid)
            {
                return NotFound();
