...
namespace ROYALHOTEL.Controllers
{
    public class ContactusController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Contactusid,Address,Phonenumber,Email,Mapurl")] Contactu contactu)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(decimal id, [Bind("Contactusid,Address,Phonenumber,Email,Mapurl")] Contactu contactu)
        {
